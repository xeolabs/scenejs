...
(function() {
    var SceneJS_teapot = function() {
        SceneJS_geometry.apply(this, arguments);
    ...
    /* TODO: use SceneJS.createNodeType to define "teapot" node
     */
    SceneJS._inherit(SceneJS_teapot, SceneJS_geometry);
    SceneJS._registerNode("teapot", SceneJS_teapot);
