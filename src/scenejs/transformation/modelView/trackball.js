...
SceneJS.Trackball.prototype._translate = function(offset, f) {
    ...
    SceneJS_math_inverseMat4(this._mat, invMat);
    ...
    SceneJS_math_mulMat4(this._mat, trMat);
};
...
SceneJS.Trackball.prototype.rotate = function(m) {
    ...
    // v0 = axis
    SceneJS_math_cross3Vec3(v0, v1);

    var angle = SceneJS_math_lenVec3(v0);
    var rotMat = SceneJS_math_rotationMat4v(angle, v0);
