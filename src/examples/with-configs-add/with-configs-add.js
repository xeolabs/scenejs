                                ...
                                SceneJS.material({
                                     ...
                                     *--------------------------------------------------------------------------------*/
                                        ...
                                        SceneJS.withConfigs({
                                            ...
                                            /* Raise a SceneJS.errors.WithConfigsPropertyNotFoundException when
                                             * a property reference on the WithConfigs configuration map
                                             * cannot be resolved to any method on a target node.
                                             */
                                            strictProperties: true,  // Default is true

                                            /* Raise a SceneJS.errors.WithConfigsNodeNotFoundException exception when
                                             * a node reference in the WithConfigs configuration map cannot be
                                             * resolved to its target node in the subgraph.
                                             */
