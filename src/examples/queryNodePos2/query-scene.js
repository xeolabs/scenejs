...
bindNodeQuery("teapot1");
bindNodeQuery("teapot2");
bindNodeQuery("teapot3");


function bindNodeQuery(nodeId) {

    SceneJS.withNode(nodeId).bind("rendering",
            function() {
...
function updateLabelPos(elementId, cameraPos, viewPos, modelPos) {
