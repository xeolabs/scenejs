                                ...
                                SceneJS.material({
                                    ...
                                    //------------------------------------------------------------------
                                        ...
                                        SceneJS.name({name: "mySymbols"},
                                            ...
                                            // does not start with a '/'. We'll also tag it with some
                                            // text to identify it.
                                            //----------------------------------------------------------

                                                SceneJS.translate({y : 10},
                                                        SceneJS.text({text: "     SceneJS.instance({name: 'teapot' }))"}),
                                    ...
                                    //------------------------------------------------------------------
                                        ...
                                        SceneJS.translate({y : 0},
                                                SceneJS.text({text:  "     SceneJS.instance({name: 'mySymbols/teapot' }))"}),
