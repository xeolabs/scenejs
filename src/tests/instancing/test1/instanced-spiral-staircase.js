                                        ...
                                        SceneJS.rotate(function(data) {
                                            return {
                                                ...
                                                SceneJS.rotate(function(data) {
                                                    ...
                                                    //------------------------------------------------------------------
                                                    // Define a "slab" symbol, inside a namespace for fun. The slab
                                                    // requires a couple of properties on the data scope: "angle" and
                                                    // "height".
                                                    //------------------------------------------------------------------
                                                    ...
                                                    //------------------------------------------------------------------
                                                    // Generate a sequence of translations and Y-axis rotations, at each
                                                    // step instancing our "slab" symbol. The Generator supplies the
                                                    // angle and offset on the data scope for the Symbol instance.
                                                    //------------------------------------------------------------------
                                                        ...
                                                        SceneJS.generator((function() {
                                                            ...
                                                            //----------------------------------------------------------
                                                            // The symbol reference is an absolute path. If the Instance
                                                            // node was in the same namespace as the Symbol, then the
                                                            // path could just be "slab".
                                                            //----------------------------------------------------------

                                                                SceneJS.instance({name: "/mySymbols/slab"}))
                                                        )
                                                )
                                        )
                                )
