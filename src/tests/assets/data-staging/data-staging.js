                                                                 ...
                                                                 */
                                                                    material({
                                                                        ...
                                                                        // Investigate ASAP
                                                                            ...
                                                                            SceneJS.translate({y:5, x: -100, z: 200},
                                                                                    SceneJS.rotate({angle:-90, x: 1},
                                                                                            SceneJS.scale({x:.1, y: .1, z: .1},
                                                                                                    SceneJS.loadCollada({
                                                                                                         uri: "http://www.scenejs.org/library/v0.7/assets/examples/tiny-kitchen/models/tiny-kitchen.dae"//,

                                                                                                    })))),
//
//                                                                            SceneJS.translate({y:7, x: -100, z: 0},
//                                                                                    SceneJS.rotate({angle:90, y: 1},
