...
with (SceneJS) {
                                                ...
                                                sources: [
                                                    ...
                                                    material({
                                                         ...
                                                         */
                                                            ...
                                                            SceneJS.translate({y:5, x: 0, z: 0},
                                                                    SceneJS.rotate({angle:180, y: 1},
                                                                            SceneJS.rotate({angle:-90, x: 1},
                                                                                    SceneJS.scale({x:.5, y: .5, z: .5},
                                                                                            SceneJS.loadCollada({
                                                                                                uri: "http://www.scenejs.org/library/v0.7/assets/examples/study/models/study.dae",
                                                                                                node: "Model"
    ...
    /** Shows frames per second in the IDE
     */
