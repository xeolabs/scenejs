/**
 ...
 // Create bloom effect around a procedurally-generated city

 var bloom = myScene.addNode({
 ...
 bloom.setTexelSize(.005);

 bloom.setBlurCoeff(0.065);

 bloom.setFocusDist(200.0);
 ...
 // When the "postprocess/bloom" is under a "lookAt" node, or any node that creates one of those, such as
 ...
 */
SceneJS.Types.addType("postprocess/bloom", {
...
//                    }
    ...
    _initCamera: function () {
        ...
        if (node && (!this._camera || node.id != this._camera.id)) {
            ...
            this._camera = node;
            var self = this;
            this._cameraSub = (!node) ? null : node.on("matrix",
                function () {
