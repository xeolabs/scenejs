(function () {
    ...
    SceneJS.Types.addType("buildings/building", {
    ...
    function initBuildingTypes(params) {
        return [
            // Building   1
            {
                freq:50,
...
//                    type:"texture",
                    ...
                    layers:[
                        {
                            src:params.texturePath + "/highrise-windows.jpg",
                            applyTo:"baseColor",
                            blendMode:"multiply",
                            wrapS:"repeat",
                            wrapT:"repeat",
            ...
            // Building   2
            {
                ...
                texture:{
                    ...
                    layers:[
                        {
                            src:params.texturePath + "/HighRiseGlass.jpg",
                            applyTo:"baseColor",
                            blendMode:"multiply",
                            wrapS:"repeat",
                            wrapT:"repeat",
                        ...
                        {
                            src:params.texturePath + "/HighRiseGlassSpecular.jpg",
                            applyTo:"specular",
                            blendMode:"multiply",
                            wrapS:"repeat",
                            wrapT:"repeat",
            ...
            // Building 3
            {
                ...
                texture:{
                    ...
                    layers:[
                        {
                            src:params.texturePath + "/pixelcity_windows7.jpg",
                            applyTo:"baseColor",
                            blendMode:"multiply",
                            wrapS:"repeat",
                            wrapT:"repeat",
