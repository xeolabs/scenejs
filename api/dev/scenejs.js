...
var SceneJS_Engine = function (json, options) {
    ...
    json.nodes = null;
    this.scene = this.createNode(json);
    json.nodes = nodes;
...
SceneJS.Node.prototype.addNode = function (node, ok) {
    ...
    if (!node._compile) {
        if (typeof node == "string") {
            ...
            var self = this;
            return this._engine.createNode(node,
                function (node) {
 ...
 */
SceneJS_NodeFactory.prototype._getType = function (typeName, ok) {
...
SceneJS.Scene.prototype.findNode = function (nodeId, callback) {
    return this._engine.getNode(nodeId, callback);
};
...
SceneJS.configure({ pluginPath: "http://xeolabs.github.com/scenejs/api/dev/plugins" });